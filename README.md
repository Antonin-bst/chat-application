...
- Authentification et profil d'un utilisateur 
  ...
  - En tant qu'utilisateur, je souhaite réinitialiser mon mot de passe avec mon adresse e-mai afin de pouvoir à nouveau accéder à l'application en cas d'oubli. 
  - En tant qu'utilisateur, je souhaite modifier mon profil en mettant à jour mes informations personnelles (nom, prénom, avatar, etc.) afin de le mettre à jour avec mes informations personnelles.
